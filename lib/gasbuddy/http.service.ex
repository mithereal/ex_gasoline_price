defmodule GasolinePrice.GasBuddy.Http.Service do
  use GenServer
  ...
  alias GasolinePrice.GasBuddy.Http
    ...
    state =
      case DateTime.compare(dt, state.last_update) do
        :gt ->
          ...
          max_queue = Application.get_env(:gasoline_price, :max_fail_rate, 50) + 5
          ...
          if reply != :good do
            ...
            fails_before_death = Application.get_env(:gasoline_price, :max_fail_rate, 50)
